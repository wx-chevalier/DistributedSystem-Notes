  ...
  - [分布式计算](/分布式计算/README.md)
    ...
    - [数据集成](/分布式计算/数据集成/README.md)
      - [Canal](/分布式计算/数据集成/Canal/README.md)
        - [架构机制](/分布式计算/数据集成/Canal/架构机制.md)
        - [部署与配置](/分布式计算/数据集成/Canal/部署与配置.md)
      - [DataPipeline](/分布式计算/数据集成/DataPipeline/README.md)
        - [一致性语义](/分布式计算/数据集成/DataPipeline/一致性语义.md)
        - [数据汇集层](/分布式计算/数据集成/DataPipeline/数据汇集层.md)
        - [数据源监听](/分布式计算/数据集成/DataPipeline/数据源监听.md)
        - [数据转换与检索](/分布式计算/数据集成/DataPipeline/数据转换与检索.md)
        - [运行环境与引擎](/分布式计算/数据集成/DataPipeline/运行环境与引擎.md)
      - [ETL](/分布式计算/数据集成/ETL/README.md)
        
      - [数据流](/分布式计算/数据集成/数据流/README.md)
        - [变更数据捕获](/分布式计算/数据集成/数据流/变更数据捕获.md)
