  - [一致性与共识](/一致性与共识/README.md)
    ...
    - [共识算法](/一致性与共识/共识算法/README.md)
      ...
      - [Raft](/一致性与共识/共识算法/Raft/README.md)
        ...
        - [成员选举与变更](/一致性与共识/共识算法/Raft/成员选举与变更.md)
        - [日志同步](/一致性与共识/共识算法/Raft/日志同步.md)
  ...
  - [分布式计算](/分布式计算/README.md)
    ...
    - [批处理](/分布式计算/批处理/README.md)
      ...
      - [执行模型](/分布式计算/批处理/执行模型/README.md)
        - [图与迭代处理](/分布式计算/批处理/执行模型/图与迭代处理.md)
        - [物化中间状态](/分布式计算/批处理/执行模型/物化中间状态.md)
        - [高级 API 和语言](/分布式计算/批处理/执行模型/高级%20API%20和语言.md)
