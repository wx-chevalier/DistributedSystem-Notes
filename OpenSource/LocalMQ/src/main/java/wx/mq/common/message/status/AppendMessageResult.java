...
/**
 * When write a message to the message log, returns results
 */
public class AppendMessageResult {
    ...
    // Where to start writing，也就是消息的起始地址
    ...
    // 消息个数
    private int appendedMessageNum = 0;
    ...
    public int getAppendedMessageNum() {
        return appendedMessageNum;
    }

    public void setAppendedMessageNum(int appendedMessageNum) {
        this.appendedMessageNum = appendedMessageNum;
    }
    ...
    public String toString() {
        return "AppendMessageResult{" +
                ...
                ", appendedMessageNum=" + appendedMessageNum +
                '}';
    }
}
