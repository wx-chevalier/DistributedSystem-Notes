...
/**
 * Description 统一的服务线程封装类
 */
public abstract class ControlledService implements Runnable {
    private static final Logger STLOG = Logger.getLogger(ControlledService.class.getName());
    private static final long JOIN_TIME = 90 * 1000;

    protected final Thread thread;
    protected final ResetableCountDown waitPoint = new ResetableCountDown(1);
