  ...
  - [5 分布式存储](/分布式存储/README.md)
    ...
    - [5.8 配置中心](/分布式存储/配置中心/README.md)
      - [5.8.1 Consul](/分布式存储/配置中心/Consul/README.md)
        
      - [5.8.2 Etcd](/分布式存储/配置中心/Etcd/README.md)
        
      - [5.8.3 Nacos](/分布式存储/配置中心/Nacos/README.md)
        - [5.8.3.1 服务注册与发现](/分布式存储/配置中心/Nacos/服务注册与发现.md)
      - [5.8.4 ZooKeeper](/分布式存储/配置中心/ZooKeeper/README.md)
        - [5.8.4.1 ZAB](/分布式存储/配置中心/ZooKeeper/ZAB.md)
        - [5.8.4.2 数据操作](/分布式存储/配置中心/ZooKeeper/数据操作.md)
        - [5.8.4.3 架构原理](/分布式存储/配置中心/ZooKeeper/架构原理.md)
        - [5.8.4.4 部署与配置](/分布式存储/配置中心/ZooKeeper/部署与配置.md)
      - 5.8.5 配置方式对比
        - [5.8.5.1 基础配置方式](/分布式存储/配置中心/配置方式对比/基础配置方式.md)
